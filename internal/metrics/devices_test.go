...
shelly_device_online{mac="AABBCC001100",name="living-room"} 1
shelly_device_online{mac="AABBCC001101",name="kitchen"} 0
`
...
shelly_device_in_sync{mac="AABBCC000001",name="dev-true"} 1
shelly_device_in_sync{mac="AABBCC000002",name="dev-false"} 0
shelly_device_in_sync{mac="AABBCC000003",name="dev-unknown"} 0
shelly_device_in_sync{mac="AABBCC000004",name="dev-absent"} 0
`
...
shelly_device_update_available{mac="AABBCC002200",name="needs-update"} 1
shelly_device_update_available{mac="AABBCC002201",name="up-to-date"} 0
`
...
func TestDeviceCollector_LabelValues(t *testing.T) {
	...
	expected := `# HELP shelly_device_online 1 if the device is online (answers discovery sweeps), 0 otherwise
# TYPE shelly_device_online gauge
shelly_device_online{mac="AABBCC003300",name="my-plug"} 1
shelly_device_online{mac="AABBCC003301",name="aabbcc003301"} 1
`
	if err := testutil.CollectAndCompare(col, strings.NewReader(expected), "shelly_device_online"); err != nil {
...
func TestDeviceCollector_MACFallback(t *testing.T) {
	...
	expected := `# HELP shelly_device_online 1 if the device is online (answers discovery sweeps), 0 otherwise
# TYPE shelly_device_online gauge
shelly_device_online{mac="aabbcc004400",name="pending-device"} 0
`
	if err := testutil.CollectAndCompare(col, strings.NewReader(expected), "shelly_device_online"); err != nil {
